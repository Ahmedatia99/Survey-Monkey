...
const OurStory = () => {
  return (
    <section className="bg-gradient-to-t from-[#490F8F] to-[#7616EC] h-[632px] w-[97%] mx-auto rounded-[10px] flex flex-col justify-center items-center p-4" >
        <div>
            <Globe color="white" size={60}/>
        </div>
        <h2 className="font-Sarabun font-bold lg:text-[67px] text-[40px] text-white">Our Story</h2>
        <p className="font-Sarabun font-[400] lg:text-[28px] text-[20px] text-wrap text-white xl:w-[1600px] text-center p-4">
