  ...
  return (
    <section className="flex flex-col items-center justify-center w-full h-full my-16 p-4" >
        <section className="text-center">
            <h1 className="font-Sarabun font-bold text-[64px] text-[#7616EC]">Get in Touch</h1>
            <p className="font-Sarabun font-normal text-[28px]">Have questions about SurveyPro? Our team is here to help you find the right solution for your needs.</p>
        </section>
        <section className="flex gap-6 items-center justify-center w-full mt-16">
            <div className="flex flex-col items-start justify-center  p-10 bg-[#7616EC] w-[40%] text-white rounded-[30px] ">
                <div className="w-full">
                    <h2 className="font-Sarabun text-[54px] font-semibold">Contact Information</h2>
                ...
                <div className="flex flex-col gap-4 my-16 w-full">
                    <div className="flex items-start flex-shrink-0 gap-4">
                        <MapPin size={30} />
                        <div>
                            <h3 className="text-[26px] font-Sarabun font-medium">Our Headquarters</h3>
                            <p className="text-[26px] font-Sarabun font-medium">123 Survey Street, San Francisco, CA 94103, United States</p>
                        </div>
                    </div>
                    <div className="flex items-start flex-shrink-0 gap-4">
                        <Phone size={30} />
                        <div>
                            <h3 className="text-[26px] font-Sarabun font-medium">Phone</h3>
                            <p className="text-[26px] font-Sarabun font-medium">+1 (555) 123-4567</p>
                        </div>
                    </div>
                    <div className="flex items-start flex-shrink-0 gap-4">
                        <Mail size={30} />
                        <div>
                            <h3 className="text-[26px] font-Sarabun font-medium">Email</h3>
                            <p className="text-[26px] font-Sarabun font-medium">info@surveypro.example</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex flex-col items-start justify-center  p-10 bg-[#FCF8FF] w-[40%] rounded-[30px]">
                <form className="flex flex-col gap-8 p-10 rounded-[30px] w-full ">
                    <h2 className="font-Sarabun text-[54px] font-semibold">Send us a message</h2>
