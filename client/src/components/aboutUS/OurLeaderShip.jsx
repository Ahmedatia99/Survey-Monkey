  ...
  return (
    <section className="my-[200px] flex flex-col gap-10 px-8 ">
        <div className="text-center">
            <h1 className="text-[#7616EC] font-Sarabun font-semibold text-[30px] mb-[10px] lg:text-[64px]">Meet Our Leadership</h1>
        ...
        <div className='mt-4 lg:flex mx-auto justify-center items-center gap-4' >
...
const CardShip = ({img , title , decription })=>{
    return(
        <div className='w-fit mb-[50px]'>
            <div className='lg:max-w-[495px] lg:w-[495px] h-[500px] overflow-hidden flex items-center justify-center'>
                <img 
                  src={img} 
            ...
            <div className='my-3'>
                <h3 className='font-Sarabun font-bold xl:text-[30px] text-[25px] text-[#7616EC]'>{title}</h3>
                <span className='font-Sarabun font-normal text-2xl opacity-70'>Chief Technology Officer</span>
                <p className='font-Sarabun font-normal text-[20px] lg:text-2xl xl:w-[480px] xl:mt-3'>{decription}</p>
            </div>
        </div>
    )
}